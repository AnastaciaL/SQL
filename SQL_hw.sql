...
-- 2a Find ID number, first name and last name of an actor, who's first name is "Joe."
...
-- 3a Keep a description of each actor. Create a column in the table actor named description and use the data type BLOB
ALTER TABLE actor
